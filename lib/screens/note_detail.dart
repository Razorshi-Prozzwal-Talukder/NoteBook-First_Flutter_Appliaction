...
class NoteDetailState extends State<NoteDetail>{
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      onWillPop: (){
        //write some code for controlling
        moveToLastScreen();
      },
...
//and display it to user in Dropdown
  ...
  void _delete()async{
    moveToLastScreen();
    //case 1: if press the delete button without saving anything
    if(note.id == null){
      _showAlertDialog('Status', 'No Note Was Deleted');
      return;
    }
    //case 2: if user want delete any note by id
